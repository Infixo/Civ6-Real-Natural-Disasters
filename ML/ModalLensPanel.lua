...
print("Registered lenses in g_ModLensModalPanel", table.count(g_ModLensModalPanel));
...
function ShowModLensKey(lensName:string)
    ...
    print("Showing " .. (lensName and lensName or "NIL") .. " modal panel");
...
print("OK loaded ModalLensPanel.lua from Real Natural Disasters");